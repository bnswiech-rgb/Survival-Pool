  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="prose prose-invert max-w-none space-y-6 text-gray-300 text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-white">5. Virtual Currency</h2>
          <p><strong className="text-white">Gold Coins</strong> are purchased virtual currency for entertainment play. Gold Coins have no monetary value, are not redeemable for cash or prizes, and are non-refundable except where required by law. All Gold Coin purchases are final.</p>
          <p><strong className="text-white">Sweeps Coins</strong> are awarded at no cost as promotional entries. Sweeps Coins may not be purchased, sold, transferred, or exchanged for cash except through our official prize redemption process. Sweeps Coins expire after 90 days of account inactivity. We reserve the right to modify, suspend, or discontinue the sweepstakes program at any time with reasonable notice.</p>
          <p>We reserve the right to void, cancel, or reverse any virtual currency balance if we determine fraudulent activity, abuse, chargebacks, or violation of these terms has occurred.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-bold text-white">6. Contests and Picks</h2>
          <p>Each round, active participants submit picks before the round deadline. Picks are graded based on actual game outcomes. Participants who fail to submit a pick before the deadline may be eliminated or assessed a loss, depending on contest format settings. All grading decisions are final.</p>
          <p>In the event of data errors from third-party sports data providers, we will use commercially reasonable efforts to correctly grade contests but shall not be liable for errors caused by inaccurate third-party data.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-bold text-white">7. User Conduct</h2>
          <p>You agree not to: create multiple accounts; use bots, scripts, or automated tools; collude with other participants; exploit bugs or errors; harass other users; create contests with offensive or illegal content; or violate any applicable laws. Violations may result in immediate account termination and forfeiture of any virtual currency balance.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-bold text-white">8. Account Responsibility</h2>
          <p>You are responsible for maintaining the security and confidentiality of your account credentials. You are responsible for all activity that occurs under your account. Notify us immediately if you suspect unauthorized access to your account.</p>
        </section>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-white">14. Termination</h2>
          <p>We reserve the right to suspend or terminate your account at any time for any reason, including violation of these Terms. Upon termination, your right to use the Platform ceases immediately. Gold Coin balances are non-refundable upon termination for cause. Sweeps Coins are forfeited upon termination for cause.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-bold text-white">15. Changes to Terms</h2>
          <p>We may update these Terms at any time. We will provide notice of material changes by updating the "Last updated" date and, where appropriate, notifying you via email or in-platform notice. Continued use of the Platform after changes constitutes acceptance of the updated Terms.</p>
        </section>
